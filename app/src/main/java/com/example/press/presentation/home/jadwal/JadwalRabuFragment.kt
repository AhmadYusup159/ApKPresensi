...
class JadwalRabuFragment : Fragment(R.layout.fragment_jadwal_rabu) {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentJadwalRabuBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val recyclerView: RecyclerView = binding?.rvJadwalRabu ?: return
    ...
    private fun fetchDataAndPopulateUI() {
        lifecycleScope.launch {
            ...
            // Panggil fungsi untuk mendapatkan dan menampilkan jadwal dari ViewModel
            viewModel.getJadwalById(userId, token, "Rabu")
