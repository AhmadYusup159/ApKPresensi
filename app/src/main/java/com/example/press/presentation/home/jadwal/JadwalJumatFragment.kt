...
class JadwalJumatFragment : Fragment(R.layout.fragment_jadwal_jumat) {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentJadwalJumatBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val recyclerView: RecyclerView = binding?.rvJadwalJumat ?: return
    ...
    private fun fetchDataAndPopulateUI() {
        lifecycleScope.launch {
            ...
            // Panggil fungsi untuk mendapatkan dan menampilkan jadwal dari ViewModel
            viewModel.getJadwalById(userId, token, "Jumat")
