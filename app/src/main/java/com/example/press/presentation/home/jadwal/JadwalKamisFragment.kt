...
import com.example.press.databinding.FragmentJadwalKamisBinding
...
class JadwalKamisFragment : Fragment(R.layout.fragment_jadwal_kamis) {

    private var _binding: FragmentJadwalKamisBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentJadwalKamisBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val recyclerView: RecyclerView = binding?.rvJadwalKamis ?: return
    ...
    private fun fetchDataAndPopulateUI() {
        lifecycleScope.launch {
            ...
            // Panggil fungsi untuk mendapatkan dan menampilkan jadwal dari ViewModel
            viewModel.getJadwalById(userId, token, "Kamis")
